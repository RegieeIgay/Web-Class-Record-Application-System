...
<html lang="en">
            ...
            <div class="average-container">
                ...
                COALESCE(AVG(CASE WHEN ts.assesment_type = 'Laboratory' THEN 
                    CASE WHEN COALESCE(tsa.score, 0) = 0 THEN (25 / 100) * 50
                        ELSE (tsa.score / ts.total_item * 100) * 0.5 
                    END 
                END), NULL) AS laboratory_average,
                ...
                END), NULL) AS assignment_average,
                    ...
                    AVG(CASE WHEN ts.assesment_type = 'Participation' THEN (tsa.score / ts.total_item * 100) * 0.5 ELSE NULL END) AS participation_average,          
                ...
                if ($result_combined_midterm->num_rows > 0) {
                    ...
                    <table>
                    <tr>
                        <th colspan="47"  style="background-color: #f593f0;">Class ID: <?php echo $class_id; ?></th>
                    </tr>
                    <tr>
                        ...
                        <th colspan="20" style="background-color: #5cf7b9">Midterm (40)</th>
                        ...
                        <th colspan="20" style="background-color: #fcaecb;">FinalTerm (60)</th>
                    ...
                    <tr>
                        ...
                        <th rowspan="2" style="background-color: #5cf7b9">Knowledge Average (40)</th>
                        <th rowspan="2" style="background-color: #5cf7b9">Knowledge Equivalent</th>
                        <th colspan="6" style="background-color: #5cf7b9">Skills </th>
                        <th rowspan="2" style="background-color: #5cf7b9">Skills Average (50)</th>
                        ...
                        <th rowspan="2" style="background-color: #fcaecb">Knowledge Average (40)</th>
                        <th rowspan="2" style="background-color: #fcaecb">Knowledge Equivalent</th>
                        <th colspan="6" style="background-color: #fcaecb">Skills </th>
                        <th rowspan="2" style="background-color: #fcaecb">Skills Average (50)</th>
                    ...
                    <tr>
                        ...
                        <th style="background-color: #5cf7b9">Laboratory Average(50)</th>
                        <th style="background-color: #5cf7b9">Laboratory Equivalent</th>
                        ...
                        <th style="background-color: #fcaecb">Laboratory Average(50)</th>
                        <th style="background-color: #fcaecb">Laboratory Equivalent</th>
                        ...
                        <th style="background-color: #fcaecb">Behavior Equivalent</th>
                         ...
                         while ($row_combined_midterm = $result_combined_midterm->fetch_assoc()) {
                             ...
                             $midterm_knowledge_average_scaled = ($midterm_knowledge_average / 100) * 40;
                             echo "<td>" . number_format($midterm_knowledge_average_scaled, 2) . '</td>';
                             echo "<td>" . number_format(($midterm_knowledge_average_scaled / 40) * 100, 2) . '</td>';
                             ...
                             echo "<td>" . ($row_combined_midterm['laboratory_average'] !== null ? number_format($row_combined_midterm['laboratory_average'], 2) : '') . "</td>";
                             echo "<td>" . ($row_combined_midterm['laboratory_average'] !== null ? number_format(($row_combined_midterm['laboratory_average'] / 50) * 100, 2) : '') . "</td>";
                             ...
                             $midterm_skills_average = (0.4 * ($row_combined_midterm['output_average'] / 40 * 100)) + (0.5 * ($row_combined_midterm['laboratory_average'] / 50 * 100)) + (0.1 * ($row_combined_midterm['assignment_average'] / 10 * 100));
                             $midterm_skills_average_scaled = ($midterm_skills_average / 100) * 50;
                             echo "<td>" . number_format($midterm_skills_average_scaled, 2) . '</td>';
                             echo "<td>" . number_format(($midterm_skills_average_scaled / 50) * 100, 2) . '</td>';
                             ...
                             echo "<td>" . ($row_combined_midterm['participation_average'] !== null ? number_format(($row_combined_midterm['participation_average'] / 50) * 100, 2) : '') . "</td>";
                             ...
                             $midterm_attitude_average = (0.5 * ($row_combined_midterm['participation_average'] / 50 * 100)) + (0.5 * ($row_combined_midterm['participation_average'] / 50 * 100));
                            ...
                            // Calculate the total scaled average
                             ...
                             $studentCounter++;
                                ...
                                if ($row_combined_finalterm) {
                                    ...
                                    $finalterm_knowledge_average_scaled = ($final_term_knowledge_average / 100) * 40;
                                    echo "<td>" . number_format($finalterm_knowledge_average_scaled, 2) . '</td>';
                                    echo "<td>" . number_format(($finalterm_knowledge_average_scaled / 40) * 100, 2) . '</td>';
                                    ...
                                    echo "<td>" . ($row_combined_finalterm['output_average'] !== null ? number_format(($row_combined_finalterm['output_average'] / 40) * 100, 2) : '') . "</td>";
                                     ...
                                     // Display Laboratory average and percentage
                                    echo "<td>" . ($row_combined_finalterm['laboratory_average'] !== null ? number_format($row_combined_finalterm['laboratory_average'], 2) : '') . "</td>";
                                    echo "<td>" . ($row_combined_finalterm['laboratory_average'] !== null ? number_format(($row_combined_finalterm['laboratory_average'] / 50) * 100, 2) : '') . "</td>";
                                    ...
                                    echo "<td>" . ($row_combined_finalterm['assignment_average'] !== null ? number_format(($row_combined_finalterm['assignment_average'] / 10) * 100, 2) : '') . "</td>";
                                              ...
                                              // Calculate and display Skills average and percentage
                                    $finalterm_skills_average = (0.4 * ($row_combined_finalterm['output_average'] / 40 * 100)) + (0.5 * ($row_combined_finalterm['laboratory_average'] / 50 * 100)) + (0.1 * ($row_combined_finalterm['assignment_average'] / 10 * 100));
                                    $finalterm_skills_average_scaled = ($finalterm_skills_average / 100) * 50;
                                    echo "<td>" . number_format($finalterm_skills_average_scaled, 2) . '</td>';
                                    echo "<td>" . number_format(($finalterm_skills_average_scaled / 50) * 100, 2) . '</td>';
                                    ...
                                    echo "<td>" . ($row_combined_finalterm['participation_average'] !== null ? number_format(($row_combined_finalterm['participation_average'] / 50) * 100, 2) : '') . "</td>";
                                    ...
                                    echo "<td>" . ($row_combined_finalterm['behavior_average'] !== null ? number_format(($row_combined_finalterm['behavior_average'] / 50) * 100, 2) : '') . "</td>";
                                        ...
                                        // Calculate and display Attitude average and percentage
                                        $final_term_attitude_average = (0.5 * ($row_combined_finalterm['participation_average'] / 50 * 100)) + (0.5 * ($row_combined_finalterm['participation_average'] / 50 * 100));
