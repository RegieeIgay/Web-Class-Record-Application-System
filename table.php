                        ...
                        foreach ($assessments as $assessment_id => $score) {
                            ...
                            if ($result_existing_score->num_rows > 0) {
                             ...
                             // Fetch student data from the database based on the class_id and order by lastname in ascending order
                                ...
                                $midtermLaboratoryAssessmentSql =  "SELECT * FROM tblassesment WHERE class_id = ? AND term = 'MidTerm' AND assesment_type = 'Laboratory' ORDER BY datetime ASC";
                                ...
                                $midtermParticipationAssessmentSql =  "SELECT * FROM tblassesment WHERE class_id = ? AND term = 'MidTerm' AND assesment_type = 'Participation' ORDER BY datetime ASC";
                                ...
                                $finaltermLaboratoryAssessmentSql = "SELECT * FROM tblassesment WHERE class_id = ? AND term = 'Final' AND assesment_type = 'Laboratory' ORDER BY datetime ASC";
                              ...
                              $finaltermParticipationAssessmentSql = "SELECT * FROM tblassesment WHERE class_id = ? AND term = 'Final' AND assesment_type = 'Participation' ORDER BY datetime ASC";
                              ...
                              while ($row = $finaltermParticipationAssessmentResult->fetch_assoc()) {
                               ...
                               while ($row = $finaltermBehaviorAssessmentResult->fetch_assoc()) {
                                ...
                                $addAssessmentLink = "addassesment.php?class_id=$class_id";
...
<body>
<form action='table.php?class_id=<?php echo $class_id; ?>' method='post'>
<input type="hidden" name="class_id" value="<?= $class_id; ?>">
    <table>
                            <thead>
                                ...
                                <th colspan="<?= $midtermSummativesColspan  + $midtermExamColspan + $midtermOutputColspan + $midtermLaboratoryColspan + $midtermAssignmentColspan + $midtermParticipationColspan + $midtermBehaviorColspan ?: 7 ?>" style="background-color: #5cf7b9;">
                                Mid Term         
                                </th>

                                <th colspan="<?= $finaltermSummativesColspan +  $midtermExamColspan + $finaltermOutputColspan + $finaltermLaboratoryColspan + $finaltermAssignmentColspan + $finaltermParticipationColspan + $finaltermBehaviorColspan ?: 7 ?>" style="background-color: #fcaecb;">
                                Final Term
                                </th>
                                </tr>
                                <tr>
                                ...
                                <!-- Mideterm KSA -->
                                <th colspan="<?= $midtermSummativesColspan + $midtermExamColspan ?: 2 ?>" style="background-color: #5cf7b9;">Knowledge</th>
                                <th colspan="<?= $midtermOutputColspan + $midtermLaboratoryColspan + $midtermAssignmentColspan ?: 3 ?>" style="background-color: #5cf7b9;">Skill</th>
                                <th colspan="<?= $midtermParticipationColspan + $midtermBehaviorColspan ?: 2 ?>" style="background-color: #5cf7b9;">Attitude</th>
                                                

                                <!-- Finalterm KSA -->
                                <th colspan="<?= $finaltermSummativesColspan + $finaltermExamColspan ?: 2 ?>" style="background-color: #fcaecb;">Knowledge</th>
                                <th colspan="<?= $finaltermOutputColspan + $finaltermLaboratoryColspan + $finaltermAssignmentColspan ?: 3 ?>" style="background-color: #fcaecb;">Skill</th>
                                <th colspan="<?= $finaltermParticipationColspan + $finaltermBehaviorColspan ?: 2 ?>" style="background-color: #fcaecb;">Attitude</th>

                                </tr>
                                <tr>
                                <!-- Midterm Assessment Titles -->
                                <th colspan="<?= count($midtermSummativesAssessmentTitles) ?: 1 ?>" style="background-color: #5cf7b9;">Summative</th>

                                <th colspan="<?= count($midtermExamAssessmentTitles) ?: 1 ?>" style="background-color: #5cf7b9;">Exam</th>
                                <th colspan="<?= count($midtermOutputAssessmentTitles) ?: 1 ?>" style="background-color: #5cf7b9;">Output</th>
                                <th colspan="<?= count($midtermLaboratoryAssessmentTitles) ?: 1 ?>" style="background-color: #5cf7b9;">Laboratory</th>
                                <th colspan="<?= count($midtermAssignmentAssessmentTitles) ?: 1 ?>" style="background-color: #5cf7b9;">Assignment</th>
                                <th colspan="<?= count($midtermParticipationAssessmentTitles) ?: 1 ?>" style="background-color: #5cf7b9;">Participation</th>
                                <th colspan="<?= count($midtermBehaviorAssessmentTitles) ?: 1 ?>" style="background-color: #5cf7b9;">Behavior</th>


                                <!-- Finalterm Assessment Titles -->
                                <th colspan="<?= count($finaltermSummativesAssessmentTitles) ?: 1 ?>" style="background-color: #fcaecb;">Summative</th>
                                <th colspan="<?= count($finaltermExamAssessmentTitles) ?: 1 ?>" style="background-color: #fcaecb;">Exam</th>
                                <th colspan="<?= count($finaltermOutputAssessmentTitles) ?: 1 ?>" style="background-color: #fcaecb;">Output</th>
                                <th colspan="<?= count($finaltermLaboratoryAssessmentTitles) ?: 1 ?>" style="background-color: #fcaecb;">Laboratory</th>
                                <th colspan="<?= count($finaltermAssignmentAssessmentTitles) ?: 1 ?>" style="background-color: #fcaecb;">Assignment</th>
                                <th colspan="<?= count($finaltermParticipationAssessmentTitles) ?: 1 ?>" style="background-color: #fcaecb;">Participation</th>
                                <th colspan="<?= count($finaltermBehaviorAssessmentTitles) ?: 1 ?>" style="background-color: #fcaecb;">Behavior</th>
